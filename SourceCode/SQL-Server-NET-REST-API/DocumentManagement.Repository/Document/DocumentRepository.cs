...
namespace DocumentManagement.Repository
{
          ...
          IDocumentRepository
    {
        ...
        {
            var collectionBeforePaging = AllIncluding(c => c.User, cs => cs.Category, cs=> cs.DocumentStatus ,cs => cs.StorageSetting).Where(c => !c.Category.IsDeleted);
        ...
        public async Task<DocumentList> GetDocumentsLibrary(string email, DocumentResource documentResource)
        {
            ...
            var collectionBeforePaging = AllIncluding(c => c.User, c => c.Category, c => c.DocumentRolePermissions, c => c.DocumentUserPermissions, c=> c.DocumentStatus,c => c.StorageSetting)
