...
{
    public class RemovePageIndexingCommandHandler(IDocumentRepository _documentRepository, Helper.PathHelper pathHelper,
            IWebHostEnvironment webHostEnvironment, ILogger<RemovePageIndexingCommandHandler> _logger, IUnitOfWork<DocumentContext> uow) : IRequestHandler<RemovePageIndexingCommand, ServiceResponse<bool>>
    {
